...
var NaturalPersonForm = function NaturalPersonForm(props) {
  ...
  return React.createElement(
    ...
    { onSubmit: function onSubmit(e) {
        e.preventDefault();OfferingSender("http://api.fogjunkossze.hu/meal-support", naturalPersonFormVals);
      } },
    React.createElement(
      'label',
      { htmlFor: 'offerer' },
...
var CompanyForm = function CompanyForm(props) {
  ...
  return React.createElement(
    'form',
    { onSubmit: function onSubmit(e) {
        e.preventDefault();OfferingSender("http://api.fogjunkossze.hu/meal-support", companyFormVals);
      } },
    React.createElement(
      'label',
      { htmlFor: 'offerer' },
...
var MealSupport = function MealSupport() {
...
var domContainer = document.querySelector('#mealOffer');
ReactDOM.render(React.createElement(MealSupport, null), domContainer);