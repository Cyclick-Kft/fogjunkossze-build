...
var transportSupport = function transportSupport() {
  var _useForm = useForm({ offerer: "", email: "", phoneNum: "", from: "", destination: "" }),
  ...
  return React.createElement(
    ...
    React.createElement("input", { type: "text", name: "from", id: "from", value: formVals.from, onChange: handleChange }),
    React.createElement(
      "label",
      { htmlFor: "destination" },
      "Hov\xE1:"
    ),
    React.createElement("input", { type: "text", name: "destination", id: "destination", value: formVals.destination, onChange: handleChange }),
    React.createElement("button", { type: "submit", onSubmit: function onSubmit(e) {
        e.preventDefault;transportOfferingSender(formVals);
      } })
  );
};
var domContainer = document.querySelector('#transport-offer');
